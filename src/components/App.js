...
import {addOne, applyNumber, changeOperation, clearDisplay, changeMemory, clearMemory} from '../actions/index.js'
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick = {()=>dispatch(changeMemory(state.total))}/>
              <CalcButton value={"MR"} onClick = {()=>dispatch(applyNumber(state.memory))}/>
              <CalcButton value={"MC"} onClick = {()=>dispatch(changeMemory())}/>
            </div>
